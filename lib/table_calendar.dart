...
class _TableCalendarState extends State<TableCalendar>
          ...
          child: Text(
            widget.headerStyle.titleTextBuilder != null
                ...
                : Jalali.fromDateTime(_calendarLogic.focusedDay).formatter.mN +
                    " " +
                    replaceFarsiNumber(
                        Jalali.fromDateTime(_calendarLogic.focusedDay)
                            .formatter
                            .yy),
  ...
  Widget _buildCell(DateTime date) {
    ...
    final eventKey = widget.events.keys
        .firstWhere((it) => Utils.isSameDay(it, date), orElse: () => null);
    final holidayKey = widget.holidays.keys
        .firstWhere((it) => Utils.isSameDay(it, date), orElse: () => null);
  ...
  Widget _buildCellContent(DateTime date) {
    ...
    if (isSelected && widget.calendarStyle.renderSelectedFirst) {
      ...
      return CellWidget(
        text: replaceFarsiNumber('${Jalali.fromDateTime(date).day}'),
